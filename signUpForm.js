...
formSubmitBtn.addEventListener("click", async function (event) {
	...
	if (stepMenuOne.className == 'formbold-step-menu1 active') {
		...
		if (fileupload.files[0] != undefined && fileupload1.files[0] != undefined && fileupload2.files[0] != undefined) {
			...
			document.getElementById('fileError').innerHTML='*Please Upload All the files'
		}
